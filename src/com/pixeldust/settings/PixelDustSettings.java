...
@SearchIndexable
public class PixelDustSettings extends DashboardFragment {
        ...
        for (int i = 0; i < mCount; i++) {
            ...
            if (mKey == null) continue;
             ...
             if (mDashBoardStyle == 1){
               if (mKey.equals("theme_customization_summary")) {
                    mPreference.setLayoutResource(R.layout.dot_dashboard_preference_top);
                } else if (mKey.equals("status_bar_settings")) {
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.pixeldust_settings;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.pixeldust_settings);
}
